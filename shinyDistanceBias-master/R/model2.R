...
#   # fid.param   = input$fid.param #distance at which monkeys run away (from my data). Can use vector of numbers or single value!
...
#   # max.detect.dist  = input$max.detect.dist
#   # di         = input$di
#   # plot_monk =  T
#   
#   
...
#   
#   monkeys.poss= array ( NA, c( dim(monkeys.pos),nrow(camwalk)))
...
#     if ( plot_monk){
#     if ( camwalk[i,1] == camwalk[2,1]){
#       monkeys.poss[1:nrow(monkeys.pos),,i] = monkeys.pos
#     }
#     }
#     
